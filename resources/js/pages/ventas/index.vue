...
import { Plus, Search, Eye, Ban } from 'lucide-vue-next';
...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
        <div class="absolute top-1.5 right-4 flex items-center gap-2">
            <Button>
                <Link :href="ventas.create()" class="flex gap-1">
                    <Plus /> Nueva Venta
                </Link>
            </Button>
        </div>
        ...
        <div class="mb-0">
            <Form method="GET" :href="ventas.index()" class="flex gap-2 flex-wrap">
            ...
            <TableBody>
                <TableRow v-for="item in collection.data" :key="item.id">
                    ...
                    <TableCell class="text-end">
                        <Button variant="secondary" size="sm" class="mr-2" title="Ver detalle">
